...
bash /mnt/afs/zhengmingkai/zyr/LlamaGen_ori2/scripts/autoregressive/sample_c2i.sh \
    ...
    --noise-top-k 0 \
    --noise-top-p 1.0 \
    --invert-probs-steps 4

# Evaluation
python3 evaluations/c2i/evaluator.py \
    /mnt/afs/zhengmingkai/zyr/LlamaGen_ori2/samples/VIRTUAL_imagenet256_labeled.npz \
    /mnt/afs/zhengmingkai/zyr/LlamaGen_ori2/samples/GPT-XL-c2i_XL_384-size-384-size-256-VQ-16-topk-0-topp-1.0-temperature-1.0-cfg-2.0-seed-0-noise-steps-4-noise-scale-0.5-noise-temp-1.0-noise-topk-0-noise-topp-1.0.npz
